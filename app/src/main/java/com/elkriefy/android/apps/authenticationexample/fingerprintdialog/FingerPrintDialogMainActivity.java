package com.elkriefy.android.apps.authenticationexample.fingerprintdialog;
...
import com.elkriefy.android.apps.authenticationexample.AuthenticationExample;
 ...
 */
public class FingerPrintDialogMainActivity extends Activity {

    private static final String TAG = FingerPrintDialogMainActivity.class.getSimpleName();
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] state) {
        if (requestCode == FINGERPRINT_PERMISSION_REQUEST_CODE && state[0] == PackageManager.PERMISSION_GRANTED) {
            setContentView(R.layout.fingerprint_dialog_activity_main);
